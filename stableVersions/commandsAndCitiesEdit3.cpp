...
struct Game {
            ...
            for (auto &city : cities)
            {
                ...
                if (dist < city.marker.getRadius())
                {
                    ...
                    if (event.type == sf::Event::MouseButtonPressed && event.mouseButton.button == sf::Mouse::Left)
                    {
                        ...
                        if (selectedArmy != -1 && playerCommands.size() < maxCommands)
                        {
                            // создание команды
                        ...
                        // вывод информации об армии в городе и выбор города для команды
    ...
    void render() {
        ...
        if (showPopup)
        {
            ...
            box.setPosition(screenW, screenH);
            window.draw(box);
            ...
            t.setPosition(screenW + 125, screenH+75);
            window.draw(t);
        }
